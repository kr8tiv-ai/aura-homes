...
```mermaid
flowchart LR
  G00["G00 exact graph approval"] --> G01["G01 canonical registry + manifests"]
  G01 --> G02["G02 freeze + claim gates"]
  G01 --> G03["G03 source CI + evidence receipts"]

  G02 --> IP01["IP01 image intake contract"]
  IP01 --> IP02["IP02 design-intent schema"]
  IP02 --> IP03["IP03 fake model adapter + fixtures"]
  IP03 --> IP04["IP04 deterministic intent compiler"]
  IP04 --> IP05["IP05 graph/document validators"]
  IP05 --> IP06["IP06 preview, explain, commit, undo"]
  IP06 --> IP07["IP07 project persistence + provenance"]
  IP07 --> IP08["IP08 picture-to-plan evaluation"]

  IP03 --> OR01["OR01 hosted OpenRouter boundary"]
  OR01 --> OR02["OR02 privacy, rate + spend controls"]
  OR02 --> OR03["OR03 image-to-intent live call"]
  OR03 --> IP04

  IP07 --> ED01["ED01 editable 2D workspace handoff"]
  ...
  AI02 --> AI03
  AI03 --> AI04["AI04 image/site/quote/speech skills"]

  ED03 --> LO01["LO01 Alberta/Canada locality pack"]
  LO01 --> LO02["LO02 site + professional handoff"]
  LO01 --> LO03["LO03 Costa Rica locality pack"]

  OR02 --> CM01["CM01 cost ledger + disclosed 15% fee"]
  CM01 --> CM02["CM02 provider-neutral checkout"]
  CM02 --> CM03["CM03 simulated transaction sandbox"]
  CM03 --> CM04["CM04 optional OKX/card adapters"]
  CM04 --> CM05["CM05 real settlement — external gates"]

  G02 --> HM01["HM01 HOMES truth registry"]
  HM01 --> HM02["HM02 community + treasury dashboard"]
  HM02 --> HM03["HM03 fund transparency — legal gate"]
  CM01 --> HM04["HM04 platform-usage connection"]
  HM03 --> HM04

  ED03 --> DV01["DV01 developer-arm boundary"]
  LO02 --> DV02["DV02 Alberta pilot proof"]
