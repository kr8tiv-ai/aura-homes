...
| `npm test` (app) — deterministic app + contract-truth specs | 679 declared (677 passed + 2 served-only skipped) |
| `npm run test:ui` (app) — Playwright against a fresh static export | 135 passed |
