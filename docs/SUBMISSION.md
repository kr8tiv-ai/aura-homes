...
**Links:** GitHub: https://github.com/kr8tiv-ai/aura-homes · Demo: **https://aurahomes.fun** (live; github.io URL 301s here once DNS settles) · Video: (link) · X: (handle) · Contracts: (OKLink tx links — pending faucet)
