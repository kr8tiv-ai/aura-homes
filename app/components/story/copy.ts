...
export const CRYPTO_BEATS: Beat[] = [
  ...
  },
  {
    ...
    n: "04",
    label: "HOMES",
    heading: "Follow the HOMES token and its planned property trust.",
    body: "HOMES is live on X Layer; the decentralized property trust it funds is still being designed in public. The proposed ledger routes 60 percent of recognized fees toward a first home and publishes acquisition evidence, operating costs, and net rental results.",
    side: "left",
    accent: "lime",
    ledger: [
      { k: "Today", v: "Token live on X Layer 196 · trust, staking, payouts still planned" },
      { k: "Next", v: "Venue fee-claim receipts on the public ledger" },
      { k: "Future", v: "First property held by the trust" },
    ],
    cta: { href: "/homes", label: "Open the HOMES ledger · how to buy" },
  },
  {
    id: "network",
    n: "05",
...
export const CRYPTO_END: End = {
  ...
  rollout: {
    text: "HOMES is live on X Layer; the trust, staking, properties, and owner vaults are planned. The home-design and project journey remains open to everyone.",
    href: "/start",
