    ...
    <div className="py-16">
      ...
      <Reveal delay={0.12} y={12}>
        <p className="mt-6 max-w-2xl text-base leading-relaxed text-aura-text/75">
          ...
          glazing. When it is yours, press one button: the same object goes to the deterministic
          plan engine and comes back as a dimensioned floor plan with a room schedule — and an
          itemised account of everything the translation had to drop.
        </p>
      </Reveal>
      <Reveal delay={0.18} y={12}>
        <p className="mt-4 max-w-2xl text-sm leading-relaxed text-aura-text/55">
          A massing and layout tool — not a structural design, not an energy model, and not a permit
          set. Everything runs in this browser: no account, no server, no key. Already answered the{" "}
