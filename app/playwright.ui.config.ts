...
export default defineConfig({
  testDir: "./tests",
  testMatch: ["budget-ui.spec.ts", "comfort-ui.spec.ts", "dashboard-project.spec.ts", "graph-ui.spec.ts", "homes-ui.spec.ts", "marketplace-ui.spec.ts", "navigation.spec.ts", "plan-catalog-ui.spec.ts", "project-ui.spec.ts", "roadmap.spec.ts", "story-quality.spec.ts", "visual-system-ui.spec.ts", "xlayer-ui.spec.ts"],
  workers: 1,
  use: {
