...
export default defineConfig({
  ...
  testMatch: ["budget-ui.spec.ts", "builder-mobile.spec.ts", "builder-viewer-tools.spec.ts", "builder-viewer.spec.ts", "comfort-ui.spec.ts", "dashboard-project.spec.ts", "evidence-drawer.spec.ts", "graph-ui.spec.ts", "homes-ui.spec.ts", "landing-film.spec.ts", "land-flow.spec.ts", "land-register-surface.spec.ts", "marketplace-ui.spec.ts", "navigation.spec.ts", "plan-catalog-ui.spec.ts", "plan-selection-visual.spec.ts", "project-ui.spec.ts", "roadmap.spec.ts", "scheme-comparison-ui.spec.ts", "story-quality.spec.ts", "visual-system-ui.spec.ts", "walkthrough.spec.ts", "xlayer-ui.spec.ts"],
  workers: 1,
  use: {
