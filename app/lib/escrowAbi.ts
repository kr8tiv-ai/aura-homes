// Contract ABIs — REGENERATED from the compiled hardhat artifacts, never
...
export const auraBuildEscrowAbi = [
  ...
  {
    "inputs": [],
    "name": "HoldbackAlreadyReleased",
    "type": "error"
  },
  {
    "inputs": [],
    "name": "HoldbackNotMatured",
    "type": "error"
  },
  {
    "inputs": [],
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "enum AuraBuildEscrow.EscrowState",
        "name": "",
        "type": "uint8"
      }
    ],
...
export const auraBuildRegistryAbi = [
  {
    "inputs": [],
    "stateMutability": "nonpayable",
    "type": "constructor"
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "indexed": false,
        "internalType": "enum AuraBuildRegistry.BuildStatus",
        "name": "status",
        "type": "uint8"
      }
    ],
    "name": "BuildStatusUpdated",
    "type": "event"
  },
  {
    "anonymous": false,
