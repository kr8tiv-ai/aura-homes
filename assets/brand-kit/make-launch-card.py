...
VARIANTS = {
    # The eco-first read.
    "x-launch-card-1200x630.png": {
        "kicker": "BUILDX AI SEASON · LIVE NOW",
        "heading": ["From USDC on", "X Layer to the keys", "of an eco home."],
        "body": [
        ...
        "foot": "@XLAYEROFFICIAL · MIT OPEN SOURCE · ALBERTA FIRST",
    },
    # The crypto-native read: the HOMES endgame - the decentralized trust,
    # the user-owned Airbnb, the RWA launchpad - presented exactly as the
    # site presents it: planned, labelled, with today's real thing named.
    "x-launch-card-crypto-1200x630.png": {
        "kicker": "BUILDX AI SEASON · ON X LAYER",
        "heading": ["A user-owned", "Airbnb for eco", "stays. On-chain."],
        "body": [
            "A decentralized property trust holds the homes;",
            "an RWA launchpad lets owners fund their own stays.",
            "Live today: open-source AI planning + USDC rails.",
        ],
        "foot": "@XLAYEROFFICIAL · $HOMES PLANNED · OPEN SOURCE",
    },
}

for filename, copy in VARIANTS.items():
    ...
    tf = manrope(12, 640)
    tracked(draw, (x, P_B - 44), copy["foot"], tf, DIM, 2)

    img.save(KIT / filename, optimize=True)
    print(filename)
