...
[![Tests](https://img.shields.io/badge/gates-736_unit_%2B_137_UI_%2B_hardware_proof-171a18?style=flat-square&labelColor=f5f5f4)](#verification)
...
| Deterministic app + contract-truth specs | **736 declared** (732 passed + 4 served-only skipped in the deterministic run) |
| Playwright UI specs against a fresh static export | **137/137 passed** at source `49d41019`; the UX07 production, served-spec, and UI-configuration blobs remain unchanged from that source-bound receipt. |
