...
[![Tests](https://img.shields.io/badge/gates-755_unit_%2B_141_UI_%2B_hardware_proof-171a18?style=flat-square&labelColor=f5f5f4)](#verification)
...
| Deterministic app + contract-truth specs | **755 declared** (751 passed + 4 served-only skipped in the deterministic run), including 18 IP03 proofs for one provider-neutral adapter/fake contract, strict intent and cost receipts, byte isolation, source binding, cancellation/timeout, and hostile error boundaries. |
| Playwright UI specs against a fresh static export | **141/141 passed** for the UX08 candidate, including phone-scope, canonical review-note, non-drag keyboard, focus, target-size, non-color, and 320/390 px reflow proof. |
